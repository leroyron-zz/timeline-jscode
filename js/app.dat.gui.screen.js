...
//    params.scrollable = common.isUndefined(params.parent) && params.scrollable === true;
    ...
    if (common.isUndefined(params.parent)) {
      ...
      var title_row = addRow(_this, title_row_name, undefined, params.inHtml);
  ...
  common.extend(
      ...
      /** @lends dat.gui.GUI */
      {
         ...
         * @instance
         */
        addFolder: function(name, inHtml) {
          ...
          var new_gui_params = { name: name, parent: this, inHtml: inHtml };
   ...
   */
  function addRow(gui, dom, liBefore, inHtml) {
    var li = document.createElement('li');
    if (dom && inHtml) li.innerHTML = dom.nodeValue;
    else if (dom) li.appendChild(dom);
    if (liBefore) {
