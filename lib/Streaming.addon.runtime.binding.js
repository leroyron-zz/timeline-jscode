            ...
            streamObj['ids']['_bi' + objs[0][1]] = new function (pkeys) {
                ...
                while (pkeys.length > 0) {
                    this[pkeys[0]] = new function (props) {
                        ...
                        this['value'] = objs[0][0][props[0][0]] = props[0][0] == 'value' ? props[0][1] : props[0][1] / dataTypePrecision// Assign starting value to both stream value and node property Math.Type.convertToPrecision(dataType, props[0][1])
