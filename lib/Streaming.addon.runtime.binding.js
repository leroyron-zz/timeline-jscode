...
(function (Streaming) {
    ...
    var _execWait = function (val, ease, duration, leapCallback, reassign, dispose, zeroIn, skipLeap) {
        if (val) {
            _struct.addon.buffer.valIn('timeline', [this.execNode], [this.execBinding], this.execLastVal, this.execLastOffset, this.execLastOffset+val, undefined, undefined, leapCallback, reassign, dispose, zeroIn, typeof skipLeap == 'undefined' ? true : skipLeap)
