...
/***/ function(module, exports, __webpack_require__) {
	...
	var GUI = function GUI(pars) {
	  ...
	  if (_common2.default.isUndefined(params.parent)) {
	    ...
	    var titleRow = addRow(_this, _titleRowName, undefined, params.inHtml);
	
	    var onClickTitle = function onClickTitle(e) {
	      e.preventDefault();
	      _this.closed = !_this.closed;
				if (_this.__ul.children[0].innerText == 'Charts')
            openToggleCharts();
	      return false;
	    };
	...
	/** @lends dat.gui.GUI */
	{
	  ...
	  add: function add(object, property) {
	    return that(this, object, property, {
	   ...
	   * @instance
	   */
	  addFolder: function addFolder(name, inHtml) {
			//
      inHtml = typeof inHtml != 'undefined' ? true : false;
			//
	    ...
	    var newGuiParams = { name: name, parent: this, inHtml: inHtml };
	 ...
	 */
	function addRow(gui, newDom, liBefore, inHtml) {
	  var li = document.createElement('li');
	  if (newDom && inHtml)
			li.innerHTML = newDom.nodeValue;
		else if (newDom)
	  ...
	  _common2.default.extend(controller, {
	    options: function options(_options) {
	      if (arguments.length > 1) {
	        ...
	        return that(gui, controller.object, controller.property, {
	          before: nextSibling,
	  ...
	  if (controller instanceof _NumberControllerSlider2.default) {
	    ...
	    var r = function r(returned) {
	      ...
	      if (_common2.default.isNumber(controller.__min) && _common2.default.isNumber(controller.__max)) {
	        ...
	        controller.remove();
	        var newController = that(gui, controller.object, controller.property, {
	...
	function that(gui, object, property, params) {
