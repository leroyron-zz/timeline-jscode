...
(function (gui, Streaming) {
    ...
    var _read = gui.controls.Streaming.__folders.access.__folders.runtime.add(that, 'readCount')
    gui.addon.bind.onruntime(_read, that, _onruntime)
    var _thrust = gui.controls.Streaming.__folders.access.__folders.runtime.add(that, 'thrustCount')
    gui.addon.bind.onruntime(_thrust, that, _onruntime)
    var _measure = gui.controls.Streaming.__folders.access.__folders.runtime.add(that, 'measureCount')
