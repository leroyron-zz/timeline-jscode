...
(function (gui, app) {
    ...
    var templateCode = function (position) {
        return ['var Authority = function (Audio = window.THREE.Audio || {}, AudioListener = window.THREE.AudioListener || {}, AudioLoader = window.THREE.AudioLoader || {}, PositionalAudio = window.THREE.PositionalAudio || {}, AudioAnalyser = window.THREE.AudioAnalyser || {}) {',
