...
(function (gui, app) {
    ...
    var _onpass = function (controller) {
        var segmentPos = _timeline.segments[_timeline.segment] ? _timeline.segments[_timeline.segment].dataset.position << 0 : _timeframe.length
        var prevSegmentPos = _timeline.segments[_timeline.segment - 1] ? _timeline.segments[_timeline.segment - 1].dataset.position << 0 : 0
        controller.style.left = (app.width - 395) * (prevSegmentPos / _timeframe.length) + 'px'
        controller.style.width = (app.width - 395) * ((segmentPos / _timeframe.length) - (prevSegmentPos / _timeframe.length)) + 'px'
    ...
    var _resize = function () {
        ...
        divCharts.style.height = (app.height - 105) + 'px'
        divCsegment.style.left = (app.width - 395) * (prevSegmentPos / _timeframe.length) + 'px'
        divCsegment.style.width = (app.width - 395) * ((segmentPos / _timeframe.length) - (prevSegmentPos / _timeframe.length)) + 'px'
    }
