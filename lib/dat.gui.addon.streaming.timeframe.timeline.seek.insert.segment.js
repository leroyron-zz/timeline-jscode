...
(function (gui, app) {
    ...
    var templateCode = function (position) {
        return ['var Authority = function (timeline = window.ctx.timeline || {}, timeframe = window.ctx.timeline.addon.timeframe || {}, buffer = window.ctx.timeline.addon.buffer || {}, binding = window.ctx.timeline.addon.binding || {}) {',
