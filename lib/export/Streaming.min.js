...
D,k,g=0;g<this.rrclen;g++)(k=this.revertCalls[g][1](this.revertCalls[g][0]||a,b))&&k<c&&(c=k);this.nextRuntimeCallback=c;this._syncOffsets(b)};this._update=function(a,b,g,e,h,p,z,t){c=a;d=b;f=g;F=e;k=h;x=p;u=z;q=t;this.updateCallbacks()};this.updateCalls=[];this.upclen=0;this.updateCallbacks=function(){for(var a=0;a<this.upclen;a++)this.updateCalls[a][1](this.updateCalls[a][0])};var G="stream",z,v,I,D,P,C,S,T;this._finalize=function(a){G=this.stream;z=this.nodesPerStream;v=this.propsPerNode;I=this._prebuff(this.propsPerNodeList);
...
A=function(a,b,c,e,g,f,h){h=h?d(this,"break",h):this;h.execLastOffset+=a||0;return h},F=function(a,b,c,g,h,f,p){p=p?d(this,"at",p):this;p.execDataPos=a?a:p.execByteOffset;p.execDataPos=p.execDataPos<e.length?p.execDataPos:e.access._reversion(p.execDataPos);p.execDataPosI=p.execData0PosI+p.execDataPos;p.value=e.access.data[p.execDataPosI]/p.precision;p.execLastOffset+=a||0;return p};return a};var d=b.addon.binding();b.addon.buffer=function(){var a=b.addon.buffer={evals:0};a.update=
function(){this.updateCallbacks()};a.updateCalls=[];a.upclen=0;a.updateCallbacks=function(){for(var a=0;a<this.upclen;a++)this.updateCalls[a][1](this.updateCalls[a][0])};a.presets=function(a){for(var b in a)l.presets[b]=a[b]};var c,d,f,l={presets:{}},m=function(a,b,c){for(var e=this.CSPL||{},d=l.presets[a].CPs,f=l.presets[a].duration,h=l.presets[a].precision,g=d.length,p=[],k=0;k<g;k++)p[k]={t:d[k].t/f*b,p:d[k].p/h*c||d[k].p};b=[];d=[];f=[];for(h=0;h<g;h++)k=p[h],b[h]=k.t,d[h]=k.p,f[h]=1;e.getNaturalKs(b,
d,f);h=p[0].t;g=p[g-1].t;for(p=new Int32Array(new ArrayBuffer(4*g));h<=g;h++)p[h]=e.evalSpline(h,b,d,f);return[p,c||l.presets[a].precision]};a.eval=function(b,h,g,p,l,w,z,v,I,D){e.access.defaults.relative=e.access.defaults.relative||!1;g=g||e.access.defaults.relative;for(var k=[],u=0,x=h.length;u<x;u++)for(var q=h[u],n=q[0],t=n.length,B=q[2],G=B.length,A=q[3],L=[],y=0;y<t;y++){for(var r=n[y],H=q[1],E=0,M=H.length;E<M;E++){c=0;if(A)if(1==A)c-=f;else if(1<A||1>A)c+=A;d=0;var Q=H[E];L[E]=H[E][0];for(var O=
0,W=Q.length;O<W;O++){var V=Q[O];L[E]=V[0];for(var X=0,U=0;U<G;U++)B[U][1]<<=0,X+=B[U][1];for(U=0;U<G;U++){var Y=B[U];f=Y[1];V[2]=f/X*V[1];V[2]=Math.Type.convertToPrecisionType(r[b].conversion,V[2]);F(b,r,V,m(Y[0],f,p||f),g,D);c+=f;d+=V[2]}}}w&&a.assignLeap(b,[r],L,!1,c,w,z,v,I);l&&(k[y]=a.getData(b,[r],L,l))}a.evals+=t*G;a.update();return k};a.exec=function(b,h,g,p,l,w,z,v,I,D){e.access.defaults.relative=e.access.defaults.relative||!1;g=g||e.access.defaults.relative;for(var k=[],u=0,x=h.length;u<
x;u++){var q=h[u],n=q[0];q=q[1];for(var t=[],G=0,A=n.length;G<A;G++){for(var L=n[G],K=d=c=0,y=q.length;K<y;K++){var r=q[K],H=r[0],E=[t[K]=r[1],r[2]],M=[r[4],r[5]];d+=Math.Type.convertToPrecisionType(L[b].conversion,r[3])||0;c=0;if(H)if(1==H)c-=f;else if(1<H||1>H)c+=H;f=M[1];E[2]=Math.Type.convertToPrecisionType(L[b].conversion,E[1]);F(b,L,E,m(M[0],f,p||f),g,D,!0);c+=f}w&&a.assignLeap(b,[L],[t],!1,c,w,z,v,I);l&&(k[G]=a.getData(b,[L],[t],l))}a.evals+=q.length}a.update();return k};a.execLerp=function(b,
c,d,f,h,g,p,l,w,D,A,C,F,L,n,N,B,J,R,K){g="prebuff"==e[b].state?e[b]:e.access;l=g.propDataLength+1;f=f[b][h].data0PosI;A-=D;C=m(C||"linear",A,A);F=F||1;if(c&&d)for(h=0,w=c.length;h<w;h++)for(var k=c[h][b],u=0,q=d.length;u<q;u++)for(var x=k[d[u]].data0PosI,t=g.data[x+D+1],z=0;z<A;z++){var v=D+z;v=v<l?v:g._reversion(v);var I=x+v;K&&g.data[I+1]==g.arguments.leap||(v=Math.lerpSubject(t,g.data[f+v+1],p*(1-(C[1]-C[0][z])/C[1])),t-=v,g.data[I+1]=t*F)}N&&a.assignLeap(b,[c[0]],d,L,n,N,B,J,R);a.evals+=c.length*
d.length;a.update()};a.assignLeap=function(a,b,c,d,f,h,g,p,l){for(var k="prebuff"==e[a].state?e[a]:e.access,u=k.propDataLength+1,q=0,x=b.length;q<x;q++)for(var m=b[q][a],n=0,w=c.length;n<w;n++){var t=m[c[n]],z=t.data0PosI,v=k.data[z];if(t.leap&&g){var A=t.leap.dataPosI;k.data[A]=0}t.leap={callback:h,dataPos:d?f:v+f,dispose:"undefined"==typeof p?!0:p,zeroIn:l};v=t.leap.dataPos;v=v<u?v:k._reversion(v);z+=v;k.data[z]=k.arguments.leap;t.leap.dataPosI=z}};var F=function(b,f,h,g,p,l,m){var k=f[h[0]].value?
"value"==h[0]?f[h[0]].value:f[h[0]].value*f[b].precision:"value"==h[0]?f[h[0]]:f[h[0]]*f[b].precision;k=m?d:k+d;f=f[b][h[0]].data0PosI;b="prebuff"==e[b].state?e[b]:e.access;m=b.data[f];m+=c;var q=b.propDataLength+1;h=h[2];var u=g[0];g=g[1];for(var x=u.length,w=0;w<x;w++){var t=m+w;t=t<q?t:b._reversion(t);t=f+t;l&&b.data[t]==b.arguments.leap||(b.data[t]=p?b.data[t]+((u[w]-(u[w+1]||0))/(g/h)<<0):k+(g-u[w])/g*h<<0)}a.update()};a.zeroOut=function(a,b,c,d,f,h){var g="prebuff"==e[a].state?e[a]:e.access,
p=g.propDataLength+1;c-=b;if(d&&f)for(var k=0,u=d.length;k<u;k++)for(var q=d[k][a],l=0,x=f.length;l<x;l++)for(var m=q[f[l]].data0PosI,n=0;n<c;n++){var w=b+n;w=w<p?w:g._reversion(w);w=m+w;h&&g.data[w+1]==g.arguments.leap||(g.data[w+1]=0)}else for(k in g.bindings.ids)for(u in d=g.bindings.ids[k].node[a],d)if(d[u].data0PosI)for(f=d[u].data0PosI,q=0;q<c;q++)l=b+q,l=l<p?l:g._reversion(l),l=f+l,h&&g.data[l+1]==g.arguments.leap||(g.data[l+1]=0)};a.valIn=function(b,c,d,f,h,g,p,l,m,w,A,F,L,T){var k="prebuff"==
e[b].state?e[b]:e.access,q=k.propDataLength+1;if(c&&d)for(var u=0,x=c.length;u<x;u++){var t=c[u][b];p=p||t.precision;for(var v=0,D=d.length;v<D;v++)for(var r=t[d[v]].data0PosI,z=g-h,I=0;I<z;I++){var G=h+I;G=G<q?G:k._reversion(G);G=r+G;T&&k.data[G+1]==k.arguments.leap||(k.data[G+1]=Math.Type.convertToPrecisionType(t.conversion,f,p))}}w&&a.assignLeap(b,[c[0]],d,l,m,w,A,F,L)};a.getforwardData=function(a,b,c,d,f){for(var h="prebuff"==e[a].state?e[a]:e.access,g=h.propDataLength+1,p=[],k=0,l=b.length;k<
l;k++){var u=b[k][a];p[k]={};for(var q=0,x=c.length;q<x;q++)for(var m=c[q],n=u[m].data0PosI,w=h.data[n]+2,t=p[k][m]=0;t<d;t++){var A=w+t;A=A<g?A:h._reversion(A);A=n+A;f&&h.data[A+1]==h.arguments.leap||(p[k][m]+=h.data[A+1]/u.precision)}}return p};a.injectData=function(a,b,c,d,f,h,g,p,l){for(var k="prebuff"==e[a].state?e[a]:e.access,u=k.propDataLength,q=0,x=b.length;q<x;q++){var m=b[q][a];g*=m.precision;p*=m.precision;for(var n=0,w=c.length;n<w;n++){var t=m["poly"==m.conversion?0:c[n]].data0PosI;var A=
k.data[t];for(var F=0;F<f;F++){var L=A+F;L=L<u?L:k._reversion(L);if("poly"==m.conversion){var v=0;for(w=d.length;v<w;v++){t=m[v].data0PosI;var r=t+L;l&&k.data[r]==k.arguments.leap||(k.data[r]=h?d[v]*m.precision+k.data[r]:d[v]*m.precision,k.data[r]=k.data[r]<g?g:k.data[r]>p?p:k.data[r])}}else r=t+L,l&&k.data[r]==k.arguments.leap||(k.data[r]=h?d*m.precision+k.data[r]:d*m.precision,k.data[r]=k.data[r]<g?g:k.data[r]>p?p:k.data[r])}}}};a.list=[];a.queue=function(){a.list=a.list;a.list.push(arguments);
return a.list.length-1};a.run=function(b){for(var c=a.list;0<c.length;){var e=Array.prototype.shift.apply(c[0]);a[e].apply(this,c[0]);c.shift()}b&&b()};a.loadData=function(b,c,e,d,f,h){var g=new window.XMLHttpRequest;g.open("GET",c,!0);g.responseType="text";g.callback=d;g.onload=function(){var c=this.response;c=c.split(",");var d=Array.prototype.shift.apply(c),g=Array.prototype.shift.apply(c);a.buffinData(b,c,e,f||d<<0,h||g<<0);this.callback&&this.callback()};g.send()};a.buffinData=function(a,b,c,
d,f){for(var h=e[a].state,g="prebuff"==h?e[a]:e.access,p=1+f,k=0,l=0,q=0;k<b.length;k++){if(0==(k-0)%d){var u=b[k];k++;l=1;q++}if(0==(k-q)%p){var m=b[k];k++;l++;q++}var x="prebuff"==h?g.ids["_bi"+u]:g.bindings.ids["_bi"+u];x=x.node[a][x[m].binding].data0PosI;for(var n=0;n<f;n++)g.data[x+c+n]=b[k],k++}};a.getData=function(b,c,d,f,h,g,p){g="prebuff"==e[b].state?e[b]:e.access;h=h?h<f||h>g.propDataLength?g.propDataLength:h:g.propDataLength;f=f?h&&f>h||f>g.propDataLength?0:f:0;return a.buffoutData(b,c,
d,f,h)};a.saveData=function(a,b){var c=document.createElement("a");document.body.appendChild(c);c.style="display: none";return function(a,b){var e=new window.Blob([[a]],{type:"octet/stream"});e=window.URL.createObjectURL(e);c.href=e;c.download=b;c.click();window.URL.revokeObjectURL(e)}}();a.buffoutData=function(a,b,c,d,f){var h="prebuff"==e[a].state?e[a]:e.access;f-=d;var g=1+f,p=c?g*c.length+c.length+1:0,k=[p,f];if(b)for(var l=0,m=b.length;l<m;l++){var q=b[l][a];if(!c){c=[];for(var u in q)"undefined"!=
typeof b[l][u]&&c.push(u)}0==p&&(p=g*c.length+c.length+1,k=[p,f]);k.push(q.binding.replace("_bi","")<<0);for(var x=0,n=c.length;x<n;x++){var w=q[c[x]];k.push(w.binding);w=w.data0PosI;k.push(h.data[w+d]);for(var A=0;A<f;A++){var t=d+A;t=t<h.propDataLength?t:h._reversion(t);k.push(h.data[w+t+1])}}}return k};return a};var c=b.addon.buffer();b.addon.buffer.ease=function(){var a=b.addon.buffer.ease={};a.precisions=100;a.update=function(){e=this.precisions;var a=d.precisions,b;for(b in d){for(var f in d[b].CPs)d[b].CPs[f].p=
d[b].CPs[f].p/a*e;d[b].duration=d.durations;d[b].precision=e}d.precisions=e;c.presets(d);this.updateCallbacks()};a.updateCalls=[];a.upclen=0;a.updateCallbacks=function(){for(var a=0;a<this.upclen;a++)this.updateCalls[a][1](this.updateCalls[a][0])};var e=a.precisions;var d={durations:100,precisions:100,linear:{CPs:[{t:0,p:100},{t:50,p:50},{t:100,p:0}]},easeInSine:{CPs:[{t:0,p:100},{t:17,p:96},{t:100,p:0}]},easeOutSine:{CPs:[{t:0,p:100},{t:83,p:3},{t:100,p:0}]},easeInOutSine:{CPs:[{t:0,p:100},{t:19,
p:92},{t:81,p:8},{t:100,p:0}]},easeInQuad:{CPs:[{t:0,p:100},{t:32,p:89},{t:75,p:44},{t:100,p:0}]},easeOutQuad:{CPs:[{t:0,p:100},{t:17,p:69},{t:74,p:6},{t:100,p:0}]},easeInOutQuad:{CPs:[{t:0,p:100},{t:17,p:93},{t:35,p:75},{t:55,p:40},{t:80,p:7},{t:100,p:0}]},easeInCubic:{CPs:[{t:0,p:100},{t:17,p:99},{t:42,p:92},{t:66,p:71},{t:86,p:35},{t:100,p:0}]},easeOutCubic:{CPs:[{t:0,p:100},{t:15,p:59},{t:33,p:30},{t:57,p:8},{t:83,p:0},{t:100,p:0}]},easeInOutCubic:{CPs:[{t:0,p:100},{t:22,p:96},{t:38,p:77},{t:50,
p:50},{t:64,p:18},{t:82,p:2},{t:100,p:0}]},easeInQuart:{CPs:[{t:0,p:100},{t:21,p:100},{t:42,p:96},{t:63,p:84},{t:82,p:54},{t:92,p:28},{t:100,p:0}]},easeOutQuart:{CPs:[{t:0,p:100},{t:12,p:58},{t:27,p:28},{t:45,p:9},{t:66,p:1},{t:81,p:0},{t:100,p:0}]},easeInOutQuart:{CPs:[{t:0,p:100},{t:15,p:100},{t:28,p:94},{t:41,p:76},{t:50,p:49},{t:57,p:26},{t:68,p:8},{t:84,p:0},{t:100,p:0}]},easeInQuint:{CPs:[{t:0,p:100},{t:24,p:100},{t:43,p:98},{t:64,p:89},{t:81,p:64},{t:93,p:28},{t:100,p:0}]},easeOutQuint:{CPs:[{t:0,
p:100},{t:9,p:61},{t:23,p:26},{t:37,p:10},{t:59,p:1},{t:78,p:0},{t:100,p:0}]},easeInOutQuint:{CPs:[{t:0,p:100},{t:16,p:99},{t:28,p:96},{t:45,p:70},{t:52,p:39},{t:60,p:17},{t:75,p:1},{t:88,p:0},{t:100,p:0}]},easeInExpo:{CPs:[{t:0,p:100},{t:9,p:99},{t:56,p:94},{t:72,p:85},{t:83,p:69},{t:92,p:42},{t:100,p:0}]},easeOutExpo:{CPs:[{t:0,p:100},{t:5,p:70},{t:22,p:21},{t:48,p:3},{t:64,p:1},{t:93,p:0},{t:100,p:0}]},easeInOutExpo:{CPs:[{t:0,p:100},{t:11,p:99},{t:21,p:99},{t:30,p:96},{t:38,p:90},{t:47,p:67},
{t:53,p:33},{t:60,p:12},{t:72,p:2},{t:79,p:0},{t:85,p:0},{t:100,p:0}]},easeInCirc:{CPs:[{t:0,p:100},{t:33,p:94},{t:54,p:83},{t:81,p:58},{t:94,p:35},{t:99,p:10},{t:100,p:0}]},easeOutCirc:{CPs:[{t:0,p:100},{t:1,p:90},{t:6,p:66},{t:14,p:48},{t:26,p:32},{t:41,p:19},{t:60,p:8},{t:79,p:2},{t:100,p:0}]},easeInOutCirc:{CPs:[{t:0,p:100},{t:17,p:97},{t:27,p:92},{t:37,p:83},{t:44,p:74},{t:47,p:67},{t:49,p:60},{t:50,p:50},{t:51,p:41},{t:53,p:31},{t:57,p:22},{t:62,p:17},{t:71,p:9},{t:82,p:3},{t:100,p:0}]},easeInBack:{CPs:[{t:0,
p:100},{t:4,p:100},{t:64,p:100},{t:86,p:53},{t:100,p:0}]},easeOutBack:{CPs:[{t:0,p:100},{t:3,p:86},{t:35,p:1},{t:95,p:0},{t:100,p:0}]},easeInOutBack:{CPs:[{t:0,p:100},{t:3,p:100},{t:46,p:69},{t:51,p:44},{t:56,p:22},{t:97,p:0},{t:100,p:0}]},easeInElastic:{CPs:[{t:0,p:100},{t:8,p:99},{t:15,p:99},{t:22,p:100},{t:32,p:100},{t:41,p:98},{t:47,p:99},{t:63,p:99},{t:74,p:90},{t:93,p:93},{t:95,p:60},{t:100,p:0}]},easeOutElastic:{CPs:[{t:0,p:100},{t:3,p:65},{t:7,p:2},{t:26,p:11},{t:38,p:0},{t:56,p:1},{t:69,
...
function(a){d.access="read";e.access.defaults.relative=!0;e.access.block=!0;this.update(a)};var F=function(){e.access.output_utilizeReadData=function(a,b,c){b=this.bindings.ids["_bi"+b];var d=b[c];d.value=a;d.property?b.node[d.property][d.binding]=d.value/b.node[this.stream].precision:b.node[d.binding]=d.value/b.node[this.stream].precision;806==c&&(b.node.blockCallback=!1)}},k=function(){e.access.output_utilizeReadData=function(a,b,c){b=this.bindings.ids["_bi"+b];c=b[c];c.value=a;c.property?b.node[c.property][c.binding]=
c.value/b.node[this.stream].precision:b.node[c.binding]=c.value/b.node[this.stream].precision}};a.resetStreamProperties=function(){e.access.revertFromTo(this.length,0)};window.resizeCalls.push(function(){d.invoke&&d.invoke()});return a};for(var f=b.addon.timeframe(),m=["comment","segment","action","sound"],l={ci:0};l.ci<m.length;l={ci:l.ci},l.ci++)b.addon.timeframe[m[l.ci]]=function(a){return function(){var b=e[m[a.ci]]={script:[]};b.accessRuntime=void 0;b.runtime=function(a,c,d){if(!f.control){for(c+=
d;a<c;a++)b.script[a]&&b.script[a].main();return b.checkNext(c)}};b.accessRevert=void 0;b.revert=function(a,c){if(!f.control)return b.checkNext(a)};b.checkNext=function(a){for(var c=e.access.propDataLength,d=a;d<b.script.length;d++)b.script[d]&&(d<c||c<a)&&(c=d);return c}}}(l),b.addon.timeframe[m[l.ci]]();b.binding=d;b.buffer=c;// Ease of Use------------------------------------------------------------------------------------------------------------------
