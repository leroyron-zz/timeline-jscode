...
this.output_utilizeReadData="Data entry portal for execute, ref this to outer functions";var k=0,A=0,x=0,v=0,K=0,H=0,z,t,I,U=-1,C=0,M=0;this._currentDataPos=function(){return this.data[2]};this._checkInContinuance=function(){if(!c)return k;k+=this.data[t];this._updateDataPos();return k};this._updateDataPos=function(a){a=a||k;z=a-x-H;t=a-z};this._checkOutRevert=function(a){if(!n)return k;this.data[t]=z=this.reversion(z+(a||e));U!=z&&(U=z,this.output_revertCall(J),this.revertCallbacks(J,z),setTimeout(function(){U=
-1},1E3));return z};this.output_revertCall="Data entry portal for execute, ref this to outer functions";this._callOutLeap=function(a){var b=this.bindings.ids["_bi"+C],g=b[M],c=b.node[w][g.binding].leap;c&&(this.data[a]=c.zeroIn||0,c.callback(),c.dispose&&(b.node[w][g.binding].leap=null,delete b.node[w][g.binding].leap))};this._readAll=function(a){for(v=x=K=A=k=0;k<Q;k++)if(0==(k-A)%N&&(C=this.data[k],F[C]&&(k-A!=A&&(A=k,K=k%G,v=0),B=F[C],N=G*B+B+1),k++,x=1,v++),(k-v)%G==K&&(H=k-x,M=this.data[k],k++,
x++,v++,z=k-x-H,t=k-z,I=t+(G-z-1),q&&(this.data[t]=J),k=this._checkInContinuance()),-1==C)k=I,this._updateDataPos();else if(0<a)this.output_utilizeReadData(this._dataVal(a),C,M);else break};this._dataVal=function(a){var b=this.data[k],g=z+a,e=t+g;g>E&&n&&(g=this._checkOutRevert(a),k=e=t+g);this.data[e]==h?(c&&(this.data[t]=g),this.data[e]=0):(k=e,this._updateDataPos(),this.data[t]=z,b=this.data[k]);k=I;this._updateDataPos();return b};this._thrustAll=function(a){for(v=x=k=0;k<Q;k++)if(0==k%N&&(C=this.data[k],
k++,x=1,v++),0==(k-v)%G&&(H=k-x,M=this.data[k],k++,x++,v++,z=k-x-H,t=k-z,I=t+(G-z-1),q&&(this.data[t]=J),k=this._checkInContinuance()),-1==C)k=I,this._updateDataPos();else if(0<a)this.output_utilizeThrustData(this._dataSum(a),C,M);else break};this._dataSum=function(a){for(var b=0,g=0;g<a;g++){var e=z+1,d=t+e;if(e>E)if(n)g--,e=this._checkOutRevert(1),k=t+e;else break;else if(this.data[d]==h){c&&(this.data[t]=e);this._callOutLeap(d);break}else k=d,this._updateDataPos(),this.data[t]=z,b+=this.data[k]}k=
I;this._updateDataPos();return b};var T=0,L;this._measureAll=function(a){L=new Int32Array(new ArrayBuffer(a*B+B+4*y));for(v=x=k=T=0;k<Q;k++)if(0==k%N&&(C=this.data[k],L[T++]=C,k++,x=1,v++),0==(k-v)%G&&(H=k-x,M=this.data[k],L[T++]=M,k++,x++,v++,z=k-x-H,t=k-z,I=t+(G-z-1),q&&(this.data[t]=J),k=this._checkInContinuance()),-1==C)k=I,this._updateDataPos();else if(0<a)this.output_utilizeMeasureData(this._dataReturn(a,L),C,M);else return;return L};this._dataReturn=function(a,b){for(var g=0;g<a;g++){var c=
z+1,e=t+c;if(c>E)if(n)g--,k=t+J,this._updateDataPos();else break;else if(this.data[e]==h){k=I;this._updateDataPos();break}else k=e,this._updateDataPos(),b[T++]=this.data[k]}k=I;this._updateDataPos();return b};this.syncOffsets=function(a){a++;for(v=x=K=A=k=0;k<Q;k++)0==(k-A)%N&&(F[this.data[k]]&&(k-A!=A&&(A=k,K=k%G,v=0),B=F[this.data[k]],N=G*B+B+1),k++,x=1,v++),(k-v)%G==K&&(H=k-x,k++,x++,v++,z=k-x-H,t=k-z,I=t+(G-z-1),q&&(this.data[t]=J),k=this._checkInContinuance(),a>E&&(a=this._checkOutRevert(a))),
this.data[t]=a,k=I,this._updateDataPos()};this.arguments={continuance:c,skip:e,rCount:O,tCount:D,revert:n,mCount:r,leap:h,reset:q,_accessed:!0};return this};this._prebuff=function(a){for(var b=a.length,c=new Int32Array(new ArrayBuffer(4*b)),f=0;f<b;f++)c[f]=a[f];return c};this.access.prototype.length=this.length};this.constructor.prototype.length=this.constructor.prototype.length||a;this.open.prototype.length=this.constructor.prototype.length;return this.open()};a(Streaming);return Streaming}(function(a){var b=
...
a.rrclen++),"accessUpdate"==c&&(a.updateCalls.push([0,this.addon[b][g].update]),a.upclen++);return a};return c};var c=b.addon.runtime={access:void 0,system:function(){var a=this.constructor,b,c,e,d,f,D,n,r,h,q,u,w;this.update=function(){return this};this.proxy=function(){return this};this.init=function(){return this};this.Pointer=function(){b=a.pointer;this.Pointer=new b;return this};this.Knob=function(){c=a.knob;this.Knob=new c;return this};this.Subject=function(){e=a.subject;this.Subject=new e;
...
this.Particle=function(){if(n||r||h||q)return u=this.Parallax.particle,this.Particle=new u,this;console.log("System Particle: No - Entity, Physic, Bound or Collision detected")};this.Rig=function(){if(n||r||h||q)return w=this.Parallax.rig,this.Rig=new w,this;console.log("System Rig: No - Entity, Physic, Bound or Collision detected")};return this instanceof a?this.That:new a}};b.addon.runtime.system.pointer=function(){var a=this.constructor,b={},c={},e={};this.bind=function(a,g){b=a;c=g;return this};
...
0)+this.continuancePosValData0}};var m=c.access.bindings.propsPerNodeList,r=m.length-1;c[g].nodesPerStream+=e.length;var h=c[g];h.length=h.length||b.length;h.ids=h.ids||{};var q=b.length;e[0][0].type=e[0][0].type?"position"==e[0][0].type||"rotation"==e[0][0].type||"f"==e[0][0].type||"Vector3"==e[0][0].constructor.name||"Euler"==e[0][0].constructor.name?e[0][0].type:d[0][0]:d[0][0];var u=e[0][0].type=Math.Type.identify(e[0][0]);a.buffIdKey=a.buffIdKey||800;a.propIdKey="radian"==u?806:801;var w=D||
Math.Type.precision(u),y=l||c.access.defaults.relative,B=[];for(l={};0<e.length;)l.buffKey=e[0][1]||a.buffIdKey,l.props="poly"==u?Math.Poly.generate(u,d[0][1],w):Math.Type.convertToPrecisionDataType(u,d.concat(),1,2,w),D="poly"==u?Math.Poly.generateKeys(d[0][1],f?f[f.length-1]:a.propIdKey):f?f.concat():Math.Poly.generateKeys(d,f?f[f.length-1]:a.propIdKey),m[r]!=D.length&&(m[l.buffKey]=D.length),h.propsPerNode=D.length>h.propsPerNode?D.length:h.propsPerNode,h.ids["_bi"+l.buffKey]=new (function(b){return function(c){e[0][0]=
e[0][0]||{};e[0][0][g]={binding:"_bi"+b.buffKey,position:h.data.length,relative:y,conversion:u,precision:w};h.data.push(a.buffIdKey=b.buffKey);a.buffIdKey++;for(var d={};0<b.props.length;)d.propKey=c[0]||a.propIdKey,this[d.propKey]=new (function(a){return function(b){if("poly"!=u&&e[0][0][b[0][0]]&&"undefined"!=typeof e[0][0][b[0][0]].value){this.property=b[0][0];var c="value"}else c=b[0][0];this.binding=c;b[0][1]=b[0][1]||0;this.value=b[0][1];"poly"!=u&&e[0][0][b[0][0]]&&"undefined"!=typeof e[0][0][b[0][0]].value?
e[0][0][b[0][0]].value="value"==b[0][0]?b[0][1]:b[0][1]/w:e[0][0][b[0][0]]="value"==b[0][0]?b[0][1]:b[0][1]/w;e[0][0][g][b[0][0]]={binding:a.propKey,data0PosI:h.data.length+1};h.data.push(a.propKey);h.data.push(1);for(c=0;c<q;c++)b[0][2]?y?h.data.push((b[0][2]-b[0][1])/q):h.data.push(b[0][1]+(b[0][2]-b[0][1])/q*c):y?h.data.push(0):h.data.push(b[0][1])}}(d))(b.props),c.shift(),b.props.shift(),a.propIdKey=d.propKey,a.propIdKey++,d={propKey:d.propKey};this.node=e[0][0];B.push(this.node)}}(l))(D),e.shift(),
l={buffKey:l.buffKey,props:l.props};return B};a.queue=function(){var a="poly"==arguments[2][0][0]?arguments[2][0][1].length:arguments[3]?arguments[3].length:arguments[2]?arguments[2].length:0;this.list=this.list||[];this.list[a]=this.list[a]||[];this.list[a].push(arguments)};a.run=function(b){console.log("Binding objects to stream - Running queue");for(var c=this.list;0<c.length;){if(c[c.length-1])for(var e=c[c.length-1],g=0;g<e.length;g++)a.init.apply(this,e[g]);c.pop()}b&&b()};return a};b.addon.binding();
...
d=[];f=[];for(g=0;g<h;g++)m=r[g],b[g]=m.t,d[g]=m.p,f[g]=1;e.getNaturalKs(b,d,f);g=r[0].t;h=r[h-1].t;for(r=new Int32Array(new ArrayBuffer(4*h));g<=h;g++)r[g]=e.evalSpline(g,b,d,f);return[r,c||l.presets[a].precision]};a.eval=function(b,g,h,m,u,w,l,B,F,E){c.access.defaults.relative=c.access.defaults.relative||!1;h=h||c.access.defaults.relative;for(var r=[],q=0,n=g.length;q<n;q++){var y=g[q];var k=y[0];var A=y[2];for(var x=y[3],v=[],K=0,H=k.length;K<H;K++){for(var z=k[K],t=y[1],p=0,R=t.length;p<R;p++){e=
0;if(x)if(1==x)e-=f;else if(1<x||1>x)e+=x;d=0;var C=t[p];v[p]=t[p][0];for(var M=0,W=C.length;M<W;M++){var L=C[M];v[p]=L[0];for(var V=0,P=0,S=A.length;P<S;P++)A[P][1]<<=0,V+=A[P][1];for(P=0;P<n;P++)S=A[P],f=S[1],L[2]=f/V*L[1],L[2]=Math.Type.convertToPrecisionType(z[b].conversion,L[2]),D(b,z,L,O(S[0],f,m||f),h,E),e+=f,d+=L[2]}}w&&a.assignLeap(b,[z],v,!1,e,w,l,B,F);u&&(r[K]=a.getData(b,[z],v,u))}}a.evals+=k.length*A.length;a.update();return r};a.exec=function(b,g,h,m,u,l,y,B,F,E){c.access.defaults.relative=
c.access.defaults.relative||!1;h=h||c.access.defaults.relative;for(var r=[],q=0,n=g.length;q<n;q++){for(var w=g[q],k=w[0],w=w[1],A=[],x=0,v=k.length;x<v;x++){for(var p=k[x],H=d=e=0,z=w.length;H<z;H++){var t=w[H],I=t[0],R=[A[H]=t[1],t[2]],C=[t[3],t[4]];d+=Math.Type.convertToPrecisionType(p[b].conversion,t[5])||0;e=0;if(I)if(1==I)e-=f;else if(1<I||1>I)e+=I;f=C[1];R[2]=Math.Type.convertToPrecisionType(p[b].conversion,R[1]);D(b,p,R,O(C[0],f,m||f),h,E,!0);e+=f}l&&a.assignLeap(b,[p],[A],!1,e,l,y,B,F);u&&
(r[x]=a.getData(b,[p],[A],u))}a.evals+=w.length}a.update();return r};a.execLerp=function(b,e,d,g,f,m,l,B,F,E,J,G,p,Q,k,A,x,v,K,H){m="prebuff"==c[b].state?c[b]:c.access;B=m.propDataLength+1;g=g[b][f].data0PosI;J-=E;G=O(G||"linear",J,J);p=p||1;if(e&&d)for(f=0,F=e.length;f<F;f++)for(var h=e[f][b],r=0,q=d.length;r<q;r++)for(var u=h[d[r]].data0PosI,n=m.data[u+E+1],w=0;w<J;w++){var y=E+w,y=y<B?y:m.reversion(y),N=u+y;H&&m.data[N+1]==m.arguments.leap||(y=Math.lerpSubject(n,m.data[g+y+1],l*(1-(G[1]-G[0][w])/
G[1])),n-=y,m.data[N+1]=n*p)}A&&a.assignLeap(b,[e[0]],d,Q,k,A,x,v,K);a.evals+=e.length*d.length;a.update()};a.assignLeap=function(a,b,e,d,g,f,m,l,F){for(var h="prebuff"==c[a].state?c[a]:c.access,r=h.propDataLength+1,q=0,u=b.length;q<u;q++)for(var n=b[q][a],k=0,w=e.length;k<w;k++){var y=n[e[k]],B=y.data0PosI,p=h.data[B];if(y.leap&&m){var H=y.leap.dataPosI;h.data[H]=0}y.leap={callback:f,dataPos:d?g:p+g,dispose:"undefined"==typeof l?!0:l,zeroIn:F};p=y.leap.dataPos;p=p<r?p:h.reversion(p);B+=p;h.data[B]=
h.arguments.leap;y.leap.dataPosI=B}};var D=function(b,g,f,m,u,l,y){var h=g[f[0]].value?"value"==f[0]?g[f[0]].value:g[f[0]].value*g[b].precision:"value"==f[0]?g[f[0]]:g[f[0]]*g[b].precision,h=y?d:h+d;g=g[b][f[0]].data0PosI;b="prebuff"==c[b].state?c[b]:c.access;y=b.data[g];y+=e;var r=b.propDataLength+1;f=f[2];var q=m[0];m=m[1];for(var w=q.length,n=0;n<w;n++){var p=y+n,p=p<r?p:b.reversion(p),p=g+p;l&&b.data[p]==b.arguments.leap||(b.data[p]=u?b.data[p]+((q[n]-(q[n+1]||0))/(m/f)<<0):h+(m-q[n])/m*f<<0)}a.update()};
a.zeroOut=function(a,b,e,g,d,f){var h="prebuff"==c[a].state?c[a]:c.access,m=h.propDataLength+1;e-=b;if(g&&d)for(var r=0,q=g.length;r<q;r++)for(var l=g[r][a],u=0,w=d.length;u<w;u++)for(var p=l[d[u]].data0PosI,k=0;k<e;k++){var n=b+k,n=n<m?n:h.reversion(n),n=p+n;f&&h.data[n+1]==h.arguments.leap||(h.data[n+1]=0)}else for(r in h.bindings.ids)for(q in g=h.bindings.ids[r].node[a],g)if(g[q].data0PosI)for(d=g[q].data0PosI,l=0;l<e;l++)u=b+l,u=u<m?u:h.reversion(u),u=d+u,f&&h.data[u+1]==h.arguments.leap||(h.data[u+
1]=0)};a.valIn=function(b,e,g,d,f,m,l,p,F,E,J,G,R,Q){var h="prebuff"==c[b].state?c[b]:c.access,r=h.propDataLength+1;if(e&&g)for(var q=0,u=e.length;q<u;q++){var n=e[q][b];l=l||n.precision;for(var w=0,y=g.length;w<y;w++)for(var t=n[g[w]].data0PosI,B=m-f,D=0;D<B;D++){var C=f+D,C=C<r?C:h.reversion(C),C=t+C;Q&&h.data[C+1]==h.arguments.leap||(h.data[C+1]=Math.Type.convertToPrecisionType(n.conversion,d,l))}}E&&a.assignLeap(b,[e[0]],g,p,F,E,J,G,R)};a.getforwardData=function(a,b,e,g,d){for(var f="prebuff"==
c[a].state?c[a]:c.access,h=f.propDataLength+1,m=[],r=0,q=b.length;r<q;r++){var l=b[r][a];m[r]={};for(var u=0,p=e.length;u<p;u++)for(var n=e[u],k=l[n].data0PosI,A=f.data[k]+2,x=m[r][n]=0;x<g;x++){var v=A+x,v=v<h?v:f.reversion(v),v=k+v;d&&f.data[v+1]==f.arguments.leap||(m[r][n]+=f.data[v+1]/l.precision)}}return m};a.injectData=function(a,b,e,g,d,f,m,l,p){for(var h="prebuff"==c[a].state?c[a]:c.access,r=h.propDataLength,q=0,u=b.length;q<u;q++){var n=b[q][a];m*=n.precision;l*=n.precision;for(var k=0,w=
e.length;k<w;k++){var y=n["poly"==n.conversion?0:e[k]].data0PosI;var v=h.data[y];for(var B=0;B<d;B++){var F=v+B,F=F<r?F:h.reversion(F);if("poly"==n.conversion)for(var z=0,w=g.length;z<w;z++){y=n[z].data0PosI;var t=y+F;p&&h.data[t]==h.arguments.leap||(h.data[t]=f?g[z]*n.precision+h.data[t]:g[z]*n.precision,h.data[t]=h.data[t]<m?m:h.data[t]>l?l:h.data[t])}else t=y+F,p&&h.data[t]==h.arguments.leap||(h.data[t]=f?g*n.precision+h.data[t]:g*n.precision,h.data[t]=h.data[t]<m?m:h.data[t]>l?l:h.data[t])}}}};
a.queue=function(){this.list=this.list||[];this.list.push(arguments);return this.list.length-1};a.run=function(b){console.log("Buffering binded objects in stream - Running queue");for(var c=this.list;0<c.length;){var e=Array.prototype.shift.apply(c[0]);a[e].apply(this,c[0]);c.shift()}b&&b()};a.loadData=function(b,c,e,g,d,f){console.log("Loading in data and buffing objects in stream - "+c);var h=new window.XMLHttpRequest;h.open("GET",c,!0);h.responseType="text";h.callback=g;h.onload=function(){var c=
this.response,c=c.split(","),g=Array.prototype.shift.apply(c),h=Array.prototype.shift.apply(c);a.buffinData(b,c,e,d||g<<0,f||h<<0);this.callback&&this.callback()};h.send()};a.buffinData=function(a,b,e,g,d){for(var f,h,m=c[a].state,r="prebuff"==m?c[a]:c.access,l=1+d,q=0,u=0,p=0;q<b.length;q++){0==(q-0)%g&&(h=b[q],q++,u=1,p++);0==(q-p)%l&&(f=b[q],q++,u++,p++);for(var n="prebuff"==m?r.ids["_bi"+h]:r.bindings.ids["_bi"+h],n=n.node[a][n[f].binding].data0PosI,k=0;k<d;k++)r.data[n+e+k]=b[q],q++}};a.getData=
...
b,e,g,d){var f="prebuff"==c[a].state?c[a]:c.access;d-=g;var h=1+d,m=e?h*e.length+e.length+1:0,r=[m,d];if(b)for(var l=0,q=b.length;l<q;l++){var p=b[l][a];if(!e){e=[];for(var u in p)"undefined"!=typeof b[l][u]&&e.push(u)}0==m&&(m=h*e.length+e.length+1,r=[m,d]);r.push(p.binding.replace("_bi","")<<0);for(var n=0,k=e.length;n<k;n++){var A=p[e[n]];r.push(A.binding);A=A.data0PosI;r.push(f.data[A+g]);for(var x=0;x<d;x++){var v=g+x,v=v<f.propDataLength?v:f.reversion(v);r.push(f.data[A+v+1])}}}return r};return a};
