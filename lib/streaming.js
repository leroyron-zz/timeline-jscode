...
var Streaming = Streaming || function () {
    this.open = this.open || function () {
        ...
        this.access = this.access || function (setcontinuance, setskip, setrCount, settCount, setrevert, setmCount, setleap, setreset) {
            ...
            this.output_utilizeReadData = 'Data entry portal for execute, ref this to outter functions'
            // thrust
            ...
            this._checkOutRevert = function (modskip) {
                ...
                var reverancy = ((this.data[data0PosI] + mS) / propDataLength) << 0
                var revertPos = ((this.data[data0PosI] + mS) - (propDataLength * reverancy) + continuancePosValData0)
            ...
            this.output_revertCall = 'Data entry portal for execute, ref this to outter functions'
            // //
            ...
            this.syncOffsets = function (syncI) {
                for (
                    ...
                    if (sI % nodeDataLength == 0) {
                        // var node_i = sI/nodeDataLength;//node index number
                        // ->> Node Selection > buffer identifye
                        sI++
                        cursor = 1
                        reads++
                    }
