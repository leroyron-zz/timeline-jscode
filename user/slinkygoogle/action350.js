var Authority = new function (app, THREE, camera, canvas, ctx) {
    ...
    this.main = function () {
        ...
        var persp, x, y, size, swallow = 0.05, lineWidth = 5, freq;
        var split = canvas.app.split.value;
        var coilX = 0;
        var coilY = 0;
        var course = spring.coil.value / (split * 2);
        var rgb = canvas.app.rgb
        ...
        ctx.rendering = function (timeFrame) {
            ...
            if (nearYellow > 10)
            nearYellow > 10 && modSplit % 25 == 1 ? addCoil() : nearYellow < 10 && modSplit % 25 == 1 ? removeCoil() : nearYellow
            else if (nearRed > 10)
            nearRed > 10 && modSplit % 25 == 1 ? addSpeed() : nearRed < 10 && modSplit % 25 == 1 ? removeSpeed() : nearRed
