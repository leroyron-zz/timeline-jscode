window.Authority = new function (app, canvas, ctx, bind, buffer) {
    ...
    ctx['action' + startLength] = function (timeFrame) {
        // let spts = this['action' + 14200].prototype.spts
        if (timeFrame > 14200 && timeFrame < 19500) spts.control = spts.length; else spts.control = 0
    ...
    var spts = ctx['action' + startLength].prototype.spts = [['3/bg.jpg', 0.5, 0.5, '1334px', '750px', 0, app.width / 1334, 0]/*, ['0/palm1.png', 0.9, 0.8, '390px', '540px', 0, 0.8, 0], ['0/palm1glow.png', 0.9, 0.8, '390px', '540px', 0, 0.8, 0], ['zipperhi.png', 0.5, 0.1, '250px', '250px', 0, 0.5, 0], ['sunflare.png', 0.5, 0.1, '650px', '650px', 0, 1, 0], ['lightstreak.png', 0.5, 0.1, '1300px', '650px', 0, 1, 0], ['orb.png', 0, 0, '89px', '89px', 0, 0, 0.0] */]
    var genSprites = []
