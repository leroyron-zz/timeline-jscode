window.Authority = new function (app, canvas, ctx, bind, buffer) {
    ...
    ctx['action' + startLength] = function (timeFrame) {
        ...
        if (timeFrame > 14200 && timeFrame < 19500) {
            ...
            for (let increment = 0; increment < 32; increment++) {
                ...
                this.fillStyle = 'rgba(47,79,79,0.5)'
    ...
    var spts = ctx['action' + startLength].prototype.spts = [
        ['3/bg.jpg', 0.5, 0.5, '1334px', '750px', 'center', 0, app.width / 1334, 0, 0, [['scaleUp', 0]], function () {
            ...
            buffer.queue('eval', stream,
                [
                    [
                    [this.position], [[['x', 0.2 - this.position.x]]], [['easeOutQuad', endLength - startLength]], startLength
                    ]
                ],
            false)
        }],
        ['3/text.png', 1.0, 0.0, '465px', '750px', 'TR', 0, app.height / 750, 0, 0, undefined, function () {
            this._resize = function () {
